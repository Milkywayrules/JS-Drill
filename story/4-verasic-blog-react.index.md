...
# #4 Verasic Story (blog): Using React + hooks + router
...
> Visit demo page: [here](/JS-Drill/4-verasic-blog-react/build)
...
*   **#4 Write your stories and let the world drown into it**
    *  Using React + hooks + router: [Story](/JS-Drill/story/?moduleName=4-verasic-blog-react.index)
